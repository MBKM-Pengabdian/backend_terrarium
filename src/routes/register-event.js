...
import { registerEvent, reminderBlastEmailEvent } from "./../controllers/register_event/create.js";
...
RegisterEventRouter.post('/reminder-event/', checkJWTAdmin, reminderBlastEmailEvent);
